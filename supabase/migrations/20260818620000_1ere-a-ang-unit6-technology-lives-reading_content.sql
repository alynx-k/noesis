...
-- Moodle course id 1554: "Unit 6_ Technology and lives_ Reading"
-- (https://lyc.ecole-ci.org/course/view.php?id=1554), resource id 12146.
...
insert into public.courses (
  ...
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$In order to write a paragraph about the good use of the internet, students of 1ère A are reading an article to get informed.$$
    ),
