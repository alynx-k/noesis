...
-- Moodle course id 2215: "Unit 5_Human Rights_ Writing"
-- (https://lyc.ecole-ci.org/course/view.php?id=2215), resource id 20022.
...
-- reformulées. Consistent with the 1ère A migration of this same unit.
insert into public.courses (
  id, grade, serie, subject, title, order_index, requires_course_id,
  content, exercise_questions, content_generated_at
) values (
  '1ere-c-ang-unit5-human-rights-writing',
  '1ere',
  'C',
  'anglais',
  ...
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$After a visit to a prison, students of 1ère C decide to write a formal letter to the representative of Human Rights Watch in order to meet the prison officials and help improve prisoners' lives.$$
    ),
