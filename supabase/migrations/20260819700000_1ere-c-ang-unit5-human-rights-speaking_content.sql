...
-- Moodle course id 2219: "Unit 5_Human Rights_Speaking"
-- (https://lyc.ecole-ci.org/course/view.php?id=2219), resource id 20058.
...
-- quels ; explications reformulées. Consistent with the 1ère A migration
-- of this same unit.
insert into public.courses (
  ...
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$After a conference on human rights, students of 1ère C decide to talk about the matter so as to help everyone enjoy their rights.$$
    ),
