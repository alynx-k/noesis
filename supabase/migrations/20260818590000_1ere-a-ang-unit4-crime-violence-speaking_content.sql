...
-- Moodle course id 1545: "Unit 4_Crime and Violence_Speaking"
-- (https://lyc.ecole-ci.org/course/view.php?id=1545), resource id 12038.
...
insert into public.courses (
  ...
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$Every day on TV, criminal and violent actions are broadcasted. Students of 1ère A are talking about the different types of crimes in order to give their opinions and suggest some solutions to this problem.$$
    ),
