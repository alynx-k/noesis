...
-- Moodle course id 914: "Unit 2_Natural resources_Reading"
-- (https://lyc.ecole-ci.org/course/view.php?id=914), resource id 4617.
...
-- target vocabulary/grammar (passive voice), consistent with the 1ère A
-- migration of this same unit.
insert into public.courses (
  ...
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$In order to write an article about the different resources on our planet, the students of 1ère C are reading a text about natural resources.$$
    ),
