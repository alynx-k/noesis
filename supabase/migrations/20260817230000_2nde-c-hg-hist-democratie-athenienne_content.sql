...
-- Histoire-Géographie, categoryid=114. Moodle course id 3653: "2nde H6-La
-- démocratie athénienne" (https://lyc.ecole-ci.org/course/view.php?id=3653).
-- Resource "Je lis le résumé de la leçon", mod_resource id 37039, redirecting
-- to pluginfile "2nde H6-La démocratie athénienne.pdf". Cross-checked against
