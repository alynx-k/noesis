...
-- Histoire-Géographie, categoryid=114. Moodle course id 3656: "2nde H9- la
-- révolution du néolithique en Côte d'ivoire"
-- (https://lyc.ecole-ci.org/course/view.php?id=3656). Resource "Je lis le
-- résumé de la leçon", mod_resource id 37075, redirecting to pluginfile "2nde
-- H9- la révolution du néolithique en Côte divoire.pdf". Cross-checked
...
insert into public.courses (
  ...
  9,
  '2nde-c-hg-hist-traites-des-noirs',
  jsonb_build_object(
