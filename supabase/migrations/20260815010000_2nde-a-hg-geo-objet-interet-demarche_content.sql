...
-- Moodle course id 3329: "2nde_GEOGRAPHIE_T1_ L1: OBJET, INTERET ET DEMARCHE"
-- (https://lyc.ecole-ci.org/course/view.php?id=3329)
-- Resource "Je lis le résumé de la leçon", mod_resource id 33199, redirecting
-- to pluginfile "2nde G1-La géographie Objet ,Intérêt et démarche.pdf".
-- Rewritten/paraphrased from the source PDF (Thème 1, Leçon 1): definition
-- and object of geography, its three domains (physique/humaine/économique),
-- its interdisciplinary character and modern tools (SIG, télédétection),
-- the five-step geographic method grouped into two phases, and the
-- practical/educational/socio-economic interest of the discipline. 100%
