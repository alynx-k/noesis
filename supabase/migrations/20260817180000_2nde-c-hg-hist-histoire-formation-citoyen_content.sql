...
-- Histoire-Géographie, categoryid=114. Moodle course id 3648: "2nde H1-
-- L'histoire et la formationndu citoyen"
-- (https://lyc.ecole-ci.org/course/view.php?id=3648). Resource "Je lis le
-- résumé de la leçon", mod_resource id 36979, redirecting to pluginfile "2nde
-- H1- Lhistoire et la formationndu citoyen.pdf". Cross-checked against the
...
insert into public.courses (
  ...
  '2nde-c-hg-hist-histoire-formation-citoyen',
  '2nde',
  'C',
  'histoire',
