...
-- Histoire-Géographie, categoryid=114. Moodle course id 3628: "2nde G4-Le
-- milieu subéquatorial ivoirien proposé"
-- (https://lyc.ecole-ci.org/course/view.php?id=3628). Resource "Je lis le
-- résumé de la leçon", mod_resource id 36739, redirecting to pluginfile "2nde
-- G4-Le milieu subéquatorial ivoirien proposé.pdf". Cross-checked against the
