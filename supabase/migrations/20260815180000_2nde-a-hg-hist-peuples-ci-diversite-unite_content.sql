...
-- Moodle course id 3314: "2nde_HISTOIRE_T3_L2: LES PEUPLES DE CÔTE D'IVOIRE,
-- DIVERSITE ET UNITE" (https://lyc.ecole-ci.org/course/view.php?id=3314)
-- Resource "Je lis le résumé de la leçon", mod_resource id 33019, redirecting
-- to pluginfile "2nde H10-Les peuples de Côte dIvoire diversité et unité.pdf".
-- Rewritten/paraphrased from the source PDF (Thème 3, Leçon 2): the
-- pre-migratory pygmy populations and "proto" ethnic groups of Côte
-- d'Ivoire, the great migratory waves (Xth-XVIIIth century) and their
-- economic/political/religious causes, the diversity of political and
-- social organizations among Ivorian peoples (Akan, Mandé, Krou, Sénoufo),
-- and the factors of unity beyond this diversity (cultural borrowing,
-- intermarriage, joking-kinship alliances, shared territory and language).
-- 100% original wording; no sentence copied from the source.
insert into public.courses (
  id, grade, serie, subject, title, order_index, requires_course_id,
  content, exercise_questions, content_generated_at
) values (
  '2nde-a-hg-hist-peuples-ci-diversite-unite',
  '2nde',
  'A',
  'histoire',
