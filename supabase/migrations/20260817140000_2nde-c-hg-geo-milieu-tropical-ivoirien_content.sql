...
-- Histoire-Géographie, categoryid=114. Moodle course id 3629: "2nde G5- Le
-- milieu tropical ivoirien"
-- (https://lyc.ecole-ci.org/course/view.php?id=3629). Resource "Je lis le
-- résumé de la leçon", mod_resource id 36751, redirecting to pluginfile "2nde
-- G5- Le milieu tropical ivoirien.pdf". Cross-checked against the
...
-- (Thème 2, Leçon 2). 100% original wording; no sentence copied from the
-- source.
insert into public.courses (
  ...
  5,
  '2nde-c-hg-geo-milieu-subequatorial-ivoirien',
  jsonb_build_object(
