...
-- Moodle course id 817: "Unit 3_Deadly viruses and diseases_Speaking"
-- (https://lyc.ecole-ci.org/course/view.php?id=817), resource id 3453.
...
-- factuelles publiques) ; explications reformulées. Consistent with the
-- 1ère A migration of this same unit.
insert into public.courses (
  id, grade, serie, subject, title, order_index, requires_course_id,
  content, exercise_questions, content_generated_at
) values (
  '1ere-c-ang-unit3-deadly-viruses-speaking',
  '1ere',
  'C',
  'anglais',
