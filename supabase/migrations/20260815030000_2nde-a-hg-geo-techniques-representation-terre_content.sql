...
-- Moodle course id 3336: "2nde_GEOGRAPHIE_T1_L3: LES TECHNIQUES DE
-- REPRESENTATION DE LA TERRE"
-- (https://lyc.ecole-ci.org/course/view.php?id=3336)
-- Resource "Je lis le résumé de la leçon", mod_resource id 33259, redirecting
-- to pluginfile "2nde G3-Les techniques de représentation de la terre.pdf".
-- Rewritten/paraphrased from the source PDF (Thème 1, Leçon 3): the globe and
-- the map as the two main representations of the Earth (advantages/
-- disadvantages of each), map types (planisphere, mappemonde, thematic,
-- topographic), cartographic projections (Mercator, Lambert, polar, UTM),
-- modern representation technologies (aerial photography, computer-assisted
-- cartography, remote sensing), and the procedure for building a map and a
-- topographic profile (contour lines, equidistance). 100% original wording;
