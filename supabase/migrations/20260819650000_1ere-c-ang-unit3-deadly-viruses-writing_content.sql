...
-- Moodle course id 913: "UNIT 3_ Deadly Viruses and Diseases_ Writing"
-- (https://lyc.ecole-ci.org/course/view.php?id=913), resource id 4605.
...
-- factuelles publiques) ; présentation et exercices reformulés. Consistent
-- with the 1ère A migration of this same unit.
insert into public.courses (
  id, grade, serie, subject, title, order_index, requires_course_id,
  content, exercise_questions, content_generated_at
) values (
  '1ere-c-ang-unit3-deadly-viruses-writing',
  '1ere',
  'C',
  'anglais',
  $$Unit 3: Deadly Viruses and Diseases (Writing)$$,
  5,
  '1ere-c-ang-unit2-natural-resources-reading',
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$On the occasion of the 'World Health Day', the students of 1ère C are writing a text about deadly viruses and diseases in order to bring people to mind health issues.$$
    ),
