...
-- Moodle course id 1535: "Unit 2_Natural resources_Listening"
-- (https://lyc.ecole-ci.org/course/view.php?id=1535), resource id 11918.
...
insert into public.courses (
  ...
  3,
  '1ere-a-ang-unit1-travel-tourism-speaking',
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$During the English class, the students of 1ère A are listening to a recording about the different natural resources in order to get informed about them. They will then discuss some issues related to the protection of our environment.$$
    ),
