...
-- Moodle course id 3355: "2nde_HISTOIRE_T2_L4: LA CIVILISATION DU SOUDAN
-- OCCIDENTAL AU MOYEN-ÂGE"
-- (https://lyc.ecole-ci.org/course/view.php?id=3355)
-- Resource "Je lis le résumé de la leçon", mod_resource id 33487, redirecting
-- to pluginfile "2nde H7-La civilisation du Soudan Occidental au Moyen-
-- Age.pdf".
-- Rewritten/paraphrased from the source PDF (Thème 2, Leçon 4): the
-- pre-Islamic civilization of Western Sudan (centralized monarchies,
-- trans-Saharan trade, hierarchical animist society), the peaceful paths of
-- Islamization (trade, ruler conversion, religious scholars, enslaved
-- people) alongside the jihad led by the Almoravids, and the impact of Islam
-- (caliphates, cultural transformation, economic dynamism). 100% original
