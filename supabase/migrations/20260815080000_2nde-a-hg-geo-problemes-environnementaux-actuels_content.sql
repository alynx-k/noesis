...
-- Moodle course id 3345: "2nde_GEOGRAPHIE_T3_L2: LES PROBLEMES
-- ENVIRONNEMENTAUX ACTUELS"
-- (https://lyc.ecole-ci.org/course/view.php?id=3345)
-- Resource "Je lis le résumé de la leçon", mod_resource id 33379, redirecting
-- to pluginfile "2nde G8 - Les problèmes environnementaux actuels.pdf".
-- Rewritten/paraphrased from the source PDF (Thème 3, Leçon 2): the range of
-- current global environmental problems (air/water pollution, global
-- warming, ozone depletion, biodiversity loss...), their mostly human causes
-- (agriculture, industry, transport) alongside natural disasters, their
-- impact on health and biodiversity, and the international/individual
-- responses (Rio Earth Summit 1992, COP process, protected areas, the
-- Convention on Biological Diversity). 100% original wording; no sentence
-- copied from the source.
insert into public.courses (
  id, grade, serie, subject, title, order_index, requires_course_id,
  content, exercise_questions, content_generated_at
) values (
  '2nde-a-hg-geo-problemes-environnementaux-actuels',
  '2nde',
  'A',
  'geographie',
