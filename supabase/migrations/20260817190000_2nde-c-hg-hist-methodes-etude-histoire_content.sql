...
-- Histoire-Géographie, categoryid=114. Moodle course id 3649: "2nde H2-Les
-- méthodes d'Etude de l'histoire"
-- (https://lyc.ecole-ci.org/course/view.php?id=3649). Resource "Je lis le
-- résumé de la leçon", mod_resource id 36991, redirecting to pluginfile "2nde
-- H2-Les méthodes dEtude de lhistoire.pdf". Cross-checked against the
