...
-- Moodle course id 3728: "Leçon 9_La période contemporaine"
-- (https://lyc.ecole-ci.org/course/view.php?id=3728), resource id 37935.
-- Contenu réécrit à partir du PDF source (programme officiel MENET-FP,
-- thème "aperçu de l'histoire de la philosophie", dernière leçon de la
-- séquence Philosophie de 1ère A — 9/9). Faits historiques et doctrinaux
-- réels (dates, biographies, doctrines de Bachelard et Sartre) et courtes
-- citations de leurs œuvres, du domaine public, utilisées à des fins
-- d'illustration pédagogique ; synthèses reformulées, non copiées
-- verbatim.
insert into public.courses (
  id, grade, serie, subject, title, order_index, requires_course_id,
  content, exercise_questions, content_generated_at
) values (
  '1ere-a-philo-periode-contemporaine',
  '1ere',
  'A',
  'philosophie',
  ...
  jsonb_build_object(
    ...
    'evaluation', jsonb_build_object(
      'scenario', $$Des élèves de 1ère A n'ont pas compris les rapports entre la théorie et l'expérience en science. Un texte de Claude Bernard leur est proposé : « Le savant complet est celui qui embrasse à la fois la théorie et la pratique expérimentale. Il constate un fait ; à propos de ce fait, une idée naît dans son esprit ; en vue de cette idée, il raisonne, institue une expérience (...) De cette expérience résultent de nouveaux phénomènes qu'il faut observer, et ainsi de suite. »$$,
      'questions', array[
