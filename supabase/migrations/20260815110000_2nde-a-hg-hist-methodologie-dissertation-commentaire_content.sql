...
-- Moodle course id 3349: "2nde_HISTOIRE_T1_L3: LA METHODOLOGIE DE LA
-- DISSERTATION ET DU COMMENTAIRE DE DOCUMENT"
-- (https://lyc.ecole-ci.org/course/view.php?id=3349)
-- Resource "Je lis le résumé de la leçon", mod_resource id 33427, redirecting
-- to pluginfile "2nde H3-les techniques de devoirs.pdf".
-- Rewritten/paraphrased from the source PDF (Thème 1, Leçon 3): the
-- structure of a history-geography dissertation (introduction with
-- presentation/problématique/plan, development, conclusion), the main types
-- of dissertation subjects and matching plans (comparative, chronological,
-- dialectical, thematic...), the practical method for tackling a
-- dissertation, and the structure and question types of the document
-- commentary exercise (introductory, comprehension, opening questions).
-- 100% original wording; no sentence copied from the source.
insert into public.courses (
  id, grade, serie, subject, title, order_index, requires_course_id,
  content, exercise_questions, content_generated_at
) values (
  '2nde-a-hg-hist-methodologie-dissertation-commentaire',
  '2nde',
  'A',
  'histoire',
