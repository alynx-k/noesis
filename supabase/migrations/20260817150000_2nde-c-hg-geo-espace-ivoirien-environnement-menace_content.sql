...
-- Histoire-Géographie, categoryid=114. Moodle course id 3631: "2nde
-- G6-L'Espace ivoirien un environnement menacé -"
-- (https://lyc.ecole-ci.org/course/view.php?id=3631). Resource "Je lis le
-- résumé de la leçon", mod_resource id 36787, redirecting to pluginfile "2nde
-- G6-LEspace ivoirien un environnement menacé -.pdf". Cross-checked against
...
-- (Thème 2, Leçon 3). 100% original wording; no sentence copied from the
-- source.
insert into public.courses (
  id, grade, serie, subject, title, order_index, requires_course_id,
  content, exercise_questions, content_generated_at
) values (
  '2nde-c-hg-geo-espace-ivoirien-environnement-menace',
  '2nde',
  'C',
  'geographie',
  $$L'espace ivoirien : un environnement menacé$$,
  6,
  '2nde-c-hg-geo-milieu-tropical-ivoirien',
  jsonb_build_object(
