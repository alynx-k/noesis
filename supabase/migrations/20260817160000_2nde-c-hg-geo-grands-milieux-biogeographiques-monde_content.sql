...
-- Histoire-Géographie, categoryid=114. Moodle course id 3634: "2nde G7-Les
-- grands milieux biogeographiques"
-- (https://lyc.ecole-ci.org/course/view.php?id=3634). Resource "Je lis le
-- résumé de la leçon", mod_resource id 36811, redirecting to pluginfile "2nde
-- G7-Les grands milieux biogeographiques.pdf". Cross-checked against the
...
-- (Thème 3, Leçon 1). 100% original wording; no sentence copied from the
-- source.
