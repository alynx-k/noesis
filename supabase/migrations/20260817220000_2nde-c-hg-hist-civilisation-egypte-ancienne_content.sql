...
-- Histoire-Géographie, categoryid=114. Moodle course id 3652: "2nde H5-La
-- Civilisation de l'Egypte ancienne_"
-- (https://lyc.ecole-ci.org/course/view.php?id=3652). Resource "Je lis le
-- résumé de la leçon", mod_resource id 37027, redirecting to pluginfile "2nde
-- H5-La Civilisation de lEgypte ancienne_.pdf". Cross-checked against the
...
insert into public.courses (
  ...
  '2nde-c-hg-hist-civilisation-egypte-ancienne',
  '2nde',
  'C',
  'histoire',
