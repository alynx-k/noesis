...
-- Moodle course id 3716: "Leçon 8_La période moderne"
-- (https://lyc.ecole-ci.org/course/view.php?id=3716), resource id 81584
-- (Philo_1C_lecon8). Contenu réécrit à partir du PDF source (programme
...
-- biographies, doctrines de Descartes, Locke, Kant) et courtes citations de
-- leurs œuvres, du domaine public, utilisées à des fins d'illustration
...
insert into public.courses (
  ...
  jsonb_build_object(
    ...
    'evaluation', jsonb_build_object(
      'scenario', $$Des élèves de 1ère débattent de l'origine de la connaissance à partir du sujet suivant : « La raison peut-elle connaître indépendamment des sens ? »$$,
      'questions', array[
