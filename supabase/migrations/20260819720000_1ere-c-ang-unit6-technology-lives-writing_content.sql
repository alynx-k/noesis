...
-- Moodle course id 2224: "Unit 6_Technology and our lives_Writing"
-- (https://lyc.ecole-ci.org/course/view.php?id=2224), resource id 20118.
...
insert into public.courses (
  ...
  '1ere-c-ang-unit6-technology-lives-writing',
  '1ere',
  'C',
  'anglais',
  ...
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$Students of 1ère C are preparing an article about technology in our lives. In order to have more information, they jot down ideas about the topic.$$
    ),
