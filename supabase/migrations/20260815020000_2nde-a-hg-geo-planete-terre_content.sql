...
-- Moodle course id 3333: "2nde_GEOGRAPHIE_T1_L2: La Planète terre"
-- (https://lyc.ecole-ci.org/course/view.php?id=3333)
-- Resource "Je lis le résumé de la leçon", mod_resource id 33235, redirecting
-- to pluginfile "2nde G2- La planète Terre..pdf".
-- Rewritten/paraphrased from the source PDF (Thème 1, Leçon 2): Earth's
-- place in the solar system (geocentrism vs. heliocentrism), its spherical
-- shape and dimensions, its internal/external structure (crust, mantle,
-- core; continents/oceans), its rotation and revolution and their
-- consequences (day/night, time zones, seasons), and continental drift /
-- plate tectonics. 100% original wording; no sentence copied from the
-- source.
insert into public.courses (
  ...
  $$La planète Terre$$,
  2,
  '2nde-a-hg-geo-objet-interet-demarche',
  jsonb_build_object(
