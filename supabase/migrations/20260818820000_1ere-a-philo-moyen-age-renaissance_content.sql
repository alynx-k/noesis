...
-- Moodle course id 3726: "Leçon 7_Le moyen-âge et la renaissance"
-- (https://lyc.ecole-ci.org/course/view.php?id=3726), resource id 37911.
...
-- doctrinaux réels (dates, biographies, doctrines de Saint Augustin et
-- Machiavel) et courtes citations de leurs œuvres, du domaine public,
-- utilisées à des fins d'illustration pédagogique ; synthèses
...
insert into public.courses (
  ...
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$Lors d'une émission télévisée, un intervenant affirme que l'exercice du pouvoir politique est inséparable du « machiavélisme ». Des élèves de 1ère A, ayant suivi l'émission, reconnaissent ce mot comme lié au philosophe Machiavel. Pour en savoir plus sur cet auteur et son époque, ils entreprennent des recherches sur les conceptions philosophiques dominantes du Moyen Âge et de la Renaissance.$$
    ),
