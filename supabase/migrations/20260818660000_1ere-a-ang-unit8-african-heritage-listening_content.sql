...
-- Moodle course id 1563: "Unit8_African Cultural Heritage_Listening"
-- (https://lyc.ecole-ci.org/course/view.php?id=1563), resource id 12254.
...
insert into public.courses (
  ...
  '1ere-a-ang-unit8-african-heritage-listening',
  '1ere',
  'A',
  'anglais',
  $$Unit 8: Our Cultural Heritage (Listening)$$,
  15,
  '1ere-a-ang-unit7-political-change-speaking',
  jsonb_build_object(
    'situation', jsonb_build_object(
      'text', $$In order to discuss the benefits of our cultural heritage, students of 1ère A are listening to an African story so as to learn more about its content.$$
    ),
