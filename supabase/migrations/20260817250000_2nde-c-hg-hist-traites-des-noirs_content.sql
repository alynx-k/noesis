...
-- Histoire-Géographie, categoryid=114. Moodle course id 3655: "2nde H8-Les
-- traites des Noirs" (https://lyc.ecole-ci.org/course/view.php?id=3655).
-- Resource "Je lis le résumé de la leçon", mod_resource id 37063, redirecting
-- to pluginfile "2nde H8-Les traites des Noirs.pdf". Cross-checked against
...
-- (Thème 2, Leçon 5). 100% original wording; no sentence copied from the
-- source.
