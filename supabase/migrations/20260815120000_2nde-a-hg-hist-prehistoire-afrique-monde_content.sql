...
-- Moodle course id 3351: "2nde_HISTOIRE_T2_L1: LA PREHISTOIRE EN AFRIQUE ET
-- DANS LE RESTE DU MONDE"
-- (https://lyc.ecole-ci.org/course/view.php?id=3351)
-- Resource "Je lis le résumé de la leçon", mod_resource id 33439, redirecting
-- to pluginfile "2nde H4- La préhistoire en Afrique et dans le reste du
-- monde.pdf".
-- Rewritten/paraphrased from the source PDF (Thème 2, Leçon 1): the two
-- great periods of prehistory (Paleolithic with its three sub-stages,
-- Neolithic and its revolutions in tools/agriculture/settlement), the stages
-- of human evolution (Australopithecus, Homo habilis, Homo erectus, Homo
-- sapiens, Homo sapiens sapiens), and the evidence that Africa is the
-- cradle of humanity (Oldoway, Lucy, Toumaï). 100% original wording; no
